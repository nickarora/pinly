...
Boardpin.create!([
  {board_id: 1, pin_id: 1, description: "Jack Daniel's Double Gold Medal Limited Edition - a specially packaged bottle sold exclusively at London's Heathrow, Gatwick and Stansted airports.  Serves me well on those long, lonely nights! #alcohol"},
  {board_id: 1, pin_id: 2, description: "This was delicious until I spilled it all over my giant phone! #alcohol"},
  {board_id: 2, pin_id: 3, description: "Is this a rabbit? So #cute!"},
  {board_id: 1, pin_id: 4, description: "Sweet sweet nectar.  I will never leave you even if I told Kelly I would try to stop. #alcohol"},
  {board_id: 2, pin_id: 5, description: "Looks just like the one we stuffed in Screech's locker :) #cat #kitty #kitten"},
  {board_id: 2, pin_id: 6, description: "It's staring deep into my soul! #cute"},
  {board_id: 1, pin_id: 7, description: "This is my go to after spending more than an hour locked in a room with AC and Mr. Belding. #alcohol"},
  {board_id: 1, pin_id: 8, description: "The whiskey family tree -- the only real family I've ever known! #alcohol"},
  {board_id: 2, pin_id: 9, description: "Oh my god -- It's so cute I need to die right now. #cute"},
  {board_id: 2, pin_id: 10, description: "This bunny's nose is so big! #cute"},
  {board_id: 2, pin_id: 11, description: "That's how Zack stares at himself sometimes... #cat #kitty #kitten"},
  {board_id: 2, pin_id: 12, description: "Such prim and proper horses! I'll have to tell daddy to buy me one!"},
  {board_id: 1, pin_id: 13, description: "Time out! I just downed six of these. #alcohol"},
  {board_id: 1, pin_id: 14, description: "Beautiful in a way that I always wanted Kelly to be.... #alcohol"},
  {board_id: 2, pin_id: 15, description: "Fangs and fur!  Such a winning combo! #cat #kitty #kitten"},
  {board_id: 3, pin_id: 16, description: "Words I live by -- except for the part where I have never suffered a single defeat.  Remind me to give Zack a noogie later. #inspiration"},
  {board_id: 3, pin_id: 17, description: "Walter Payton aka Sweetness my alltime favorite running back. More importantly, outside of football, he was a great man. #football"},
  ...
  {board_id: 4, pin_id: 19, description: "15 Life changing books on entrepreneurship!  You MUST follow this link.  Too bad most of my friends are illiterate. #books #reading"},
  {board_id: 6, pin_id: 20, description: "YES!  These girls fly high!  #cheer #squad"},
  {board_id: 6, pin_id: 22, description: "This lady's story is sooo Inspirational.  Particularly because she's pulling off that zebra print so well! #cheer #disability"},
  {board_id: 4, pin_id: 23, description: "Six Tips on Writing by John Steinbeck -- a personal hero.  I cannot wait for the day I graduate and I can speak to people who relate to articles like this!  It's like I'm surrounded by imbeciles! #author"},
  {board_id: 7, pin_id: 24, description: "Ah the praying mantis.  Did you know the female mantis eats the male after mating?  I'd sooo let Lisa Turtle do that to me.. #insect #bug"},
  {board_id: 3, pin_id: 25, description: "Reminds me of the time I beat the school swim record to impress Kelly -- and then she just made out with Zack.  Remind me to punch Zack. #swim"},
  {board_id: 5, pin_id: 26, description: "Who's the person who decided men can't wear curlers?  Sometimes I just want to curl! #hairstyle"},
  {board_id: 6, pin_id: 28, description: "Our school needs pom poms so badly.  We spent our whole budget paying Zack Attack to perform at the school ball :( #diy"},
  {board_id: 7, pin_id: 29, description: "Lady bugs are my kindov lady! #insect #bug"},
  {board_id: 4, pin_id: 30, description: "You've said it all Jack Kerouac! #author"},
  {board_id: 3, pin_id: 31, description: "You think a preppie could pull that off? #football"},
  {board_id: 5, pin_id: 32, description: "For the record, I was pulling off the undercut way before it was cool. #hairstyle"},
  {board_id: 7, pin_id: 34, description: "Just paint me blue and call me a Smurf! #ant #insect #bug #macro #water drop"},
  {board_id: 4, pin_id: 35, description: "Why can't Fitzgerald write ME a love letter? #fitzgerald #author"},
  {board_id: 8, pin_id: 36, description: "My sweet baby honey #kelly"},
  {board_id: 8, pin_id: 37, description: "Snookums! #kelly"},
  {board_id: 8, pin_id: 38, description: "Kel Kel Baby #kelly"},
  {board_id: 8, pin_id: 39, description: "My sweetie pie #kelly"},
  {board_id: 9, pin_id: 40, description: "Feeling the groove flow through my body.  Gives me shivers just thinking about it! #zack attack"},
  {board_id: 9, pin_id: 41, description: "Just a candid shot of the band-members hanging out! Exclusive behind the scenes material! #zack attack"},
  {board_id: 9, pin_id: 42, description: "Doesn't get much better than this! #zack attack"},
  {board_id: 9, pin_id: 43, description: "The early years.  Before I could afford a guitar. #zack attack"},
  {board_id: 9, pin_id: 44, description: "Today's musicians doesn't understand the importance of image to music. #zack attack"},
  {board_id: 9, pin_id: 45, description: "Worn by one of our many groupies. #zack attack"}
])
Comment.create!([
